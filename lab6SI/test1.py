...
def load_data():
    ...
    Data = pd.read_excel("E:\\SI\\lab6SI\\DataRegression.xlsx", sheet_name="Var18")
...
def obj(b):
    b1, b2, b3 = b
    return sum([(y_f[i] - (b1*(b2+x_f[i])**(-1/b3)))**2 for i in range(len(x_f))])
...
# bounds = asarray([[-10000, -1000], [1, 100], [0,1]])
